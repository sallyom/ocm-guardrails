...
OpenClaw Gateway (OAuth Protected):
  ...
  • Authentication: OpenShift OAuth (automatic)
  • Token: <auto-generated>

Moltbook Platform:
  • API (unprotected, for agents): https://moltbook-api.apps.yourcluster.com
...
ocm-platform-openshift/
├── scripts/
│   ├── build-and-push.sh       # Build images with podman
...
│   └── otel-collector-config.yaml.reference  # Legacy reference
│
└── docs/
